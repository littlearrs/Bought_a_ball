...
if __name__ == '__main__':
    # 图像和标签文件夹
    image_path = r"D:\Vscode_Project\data_aug\DataAugYolo\train\images"
    label_path = r"D:\Vscode_Project\data_aug\DataAugYolo\train\labels"
    save_path = "./train/Augumentation"    # 结果保存位置路径，可以是一个不存在的文件夹
    # 运行
